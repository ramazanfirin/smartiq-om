...
/**
 * REST controller for managing {@link com.smartiq.om.domain.Order}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class OrderResource {
    ...
    public OrderResource(OrderRepository orderRepository,AddressRepository addressRepository) {
    ...
    @PostMapping("/orders/updateAddress/{orderId}")
    public Order updateAddress(@PathVariable Long orderId, @RequestBody com.smartiq.om.domain.Address address) {
    ...
    @GetMapping("/orders/completed/{orderId}")
    public Order completed(@PathVariable Long orderId) {
